...
/**
 * Created by Emilino on 13/07/2015.
 */
public class BagsaDB extends SQLiteOpenHelper {
    ...
    public BagsaDB(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
